    ...
    degreeSave: function () {
      ...
      for (let i=0; i<this.news_list.length; ++i) {
        ...
        axios
          ...
          .then((response) => { `status: ${console.log(response.data.status)}`; });
      }
    }
  }
})
      ...
      recognition.onresult = (event) => {
        ...
        if (finalText.length > 0) {
          ...
          axios
            ...
            .then((response) => { console.log(`responded text: ${response.data.res.text}`); });
        }
      }
